/**handles:wphb-global,rank-math,hello-theme-frontend**/
...
!function(){"use strict";var e,r={n:function(n){var t=n&&n.__esModule?function(){return n.default}:function(){return n};return r.d(t,{a:t}),t},d:function(n,t){for(var a in t)r.o(t,a)&&!r.o(n,a)&&Object.defineProperty(n,a,{enumerable:!0,get:t[a]})},o:function(n,t){return Object.prototype.hasOwnProperty.call(n,t)}},n=jQuery;(e=r.n(n)())(function(){window.rankMathFront={init:function(){this.adminMenu()},adminMenu:function(){var n=e("#wp-admin-bar-rank-math-mark-me"),t=this;n.on("click",".mark-page-as a",function(n){n.preventDefault(),t.ajax("mark_page_as",{objectID:rankMath.objectID,objectType:rankMath.objectType,what:e(this).attr("href").replace("#","")}),e(this).find(".dashicons").length?e(this).find(".dashicons").remove():e(this).prepend('<span class="dashicons dashicons-yes" style="font-family:dashicons;font-size:19px;line-height:28px;margin:0 3px 0 -4px;"></span>')})},ajax:function(n,t,a){return e.ajax({url:rankMath.ajaxurl,type:a||"POST",dataType:"json",data:e.extend(!0,{action:"rank_math_"+n,security:rankMath.security},t)})}},window.rankMathFront.init()})}();
/******/ (() => { // webpackBootstrap
/******/ 	"use strict";
