...
class InsertLocalProductService extends AbstractInsertLocalResourceService
{
    ...
    /** @var InsertMissingAttachmentsService service class to help insert any attachments we don't have locally */
    ...
    public function __construct(
        ...
        InsertMissingAttachmentsService $insertMissingAttachmentsService,
    ...
    protected function insertMissingAttachments(ProductBase $remoteProduct) : array
    {
        try {
            if ($remoteProduct->assets) {
                return $this->insertMissingAttachmentsService->handle($remoteProduct->assets);
            }
